...
Whole-meeting cpWER vs AssemblyAI `universal-3-pro` (same references and scoring; lower is better): AMI 33.31 vs 38.64, ICSI 21.19 vs 35.27, NOTSOFAR-1 34.84 vs 36.68. Details and meeting IDs on the [model card](https://huggingface.co/Trelis/tiron).
